...
function Square({position,onDrop,nombreCase,bateauImg,stateBateau,lieuBateau}) {
  ...
  return (
    ...
    <td colSpan={nombreCase} className={mesClasses} onClick={()=> setClasses("Square")} style={{backgroundImage: isOver ? "url(./images/ondrop.jpg)" : bateauImg}} ref={drop}>
...
export default function App()  {
  ...
  const [flotte, setBateaux] = useState([
    {bateauID:1, nombreCase:5, bateauImg:"./images/porteavion.jpg", bateauImgDet:["./images/porteavion1.jpg","./images/porteavion2.jpg","./images/porteavion3.jpg","./images/porteavion4.jpg","./images/porteavion5.jpg"]},
    {bateauID:2, nombreCase:4, bateauImg:"./images/croiseur.jpg", bateauImgDet:["./images/croiseur1.jpg","./images/croiseur2.jpg","./images/croiseur3.jpg","./images/croiseur4.jpg"]},
    {bateauID:3, nombreCase:3, bateauImg:"./images/sousmarin.jpg", bateauImgDet:["./images/sousmarin1.jpg","./images/sousmarin2.jpg","./images/sousmarin3.jpg"]},
    {bateauID:4, nombreCase:3, bateauImg:"./images/sousmarin.jpg", bateauImgDet:["./images/sousmarin1.jpg","./images/sousmarin2.jpg","./images/sousmarin3.jpg"]},
    {bateauID:5, nombreCase:2, bateauImg:"./images/torpilleur.jpg", bateauImgDet:["./images/torpilleur1.jpg","./images/torpilleur2.jpg"]}
  ]);
